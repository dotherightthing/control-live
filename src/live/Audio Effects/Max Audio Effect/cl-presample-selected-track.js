...
include('_cl-get-track-ids.js', lib);
include('_cl-log.js', console);
include('_cl-self-on-master-track.js', lib);
 ...
 */
function loadbang() {
    console.log('cl-presample-selected-track initialized.'); // eslint-disable-line no-console
}
