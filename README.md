...
|-----------------|-----------------------------|-----------------------------|
| Push2           | Ableton Push 2 (User Port)  | Ableton Push 2 (User Port)  |
| ClyphX Pro      | IAC Driver (StreamDeck2Daw) | IAC Driver (Daw2StreamDeck) |
| MackieControl   | MCU Pro USB v3.1 (Port 1)   | MCU Pro USB v3.1 (Port 1)   |
...
| MackieControl   | IAC Driver (Mackie2Daw)     | IAC Driver (Daw2Mackie)     | StreamDeck template     |
